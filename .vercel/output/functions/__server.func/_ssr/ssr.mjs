...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-kHPnur2_.mjs");
...
var manifest = {
	"132aacdd50ec3d941551bdbe0206e99bb3f8aea78806796e9f5aba39610ee55b": {
		functionName: "getPayConfig_createServerFn_handler",
		importer: () => import("./checkout-o-SCFMnw.mjs")
	},
	"4927c775c77a8e9730b32ac7899d300bb47bed2e2fe0b3c1ef863f69f002f0ba": {
		functionName: "canUnlockFromPaidFlag_createServerFn_handler",
		importer: () => import("./checkout-o-SCFMnw.mjs")
	},
	"78e37f8c9c23c0b9b0012d58d12fa13d79860762e888f76a19fc5a33f3d8a821": {
		functionName: "confirmCheckout_createServerFn_handler",
		importer: () => import("./checkout-o-SCFMnw.mjs")
	},
	"8f68fe515934505b719754cfb5ea90121654c7dd4487cd4468056c08a221967a": {
		functionName: "startCheckout_createServerFn_handler",
		importer: () => import("./checkout-o-SCFMnw.mjs")
	},
	"e8e378687dfa890ecf9a50f4aaabb46128611cf4cb0d82c4362cd2fac8bcecd2": {
		functionName: "sparkSuggestions_createServerFn_handler",
		importer: () => import("./suggest-DkBwYArm.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DVeLkr-O.mjs").then((n) => n.t),
